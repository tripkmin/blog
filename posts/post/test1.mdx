---
title: contentlayer.config.js
date: 2023-12-31
draft: false
tags:
  - check
series: blog-generate
techs:
  - Next.js
---
...
Now inside the `resolve` method we'll write the code that will fetch every heading from the MDX file using a very complex regex.
